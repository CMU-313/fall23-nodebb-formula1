...
const details = function (req, res, next) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const [groupData, posts] = yield Promise.all([groups_1.default.get(groupName, {
      uid: req.uid,
...
const members = function (req, res, next) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unsafe-call
    groups_1.default.getGroupData(groupName), user_1.default.isAdminOrGlobalMod(req.uid),
    // eslint-disable-next-line @typescript-eslint/no-unsafe-call
    groups_1.default.isMember(req.uid, groupName), groups_1.default.isHidden(groupName)]);
