...
const list = function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function withOnineUserCount(groupData) {
            return __awaiter(this, void 0, void 0, function* () {
                return Object.assign(Object.assign({}, groupData), {
                    ...
                    onlineUserCount: yield user_1.default.getGroupOnlineCount(
                        groupData.name,
                    ),
                });
            });
        ...
        const groupsDataWithOnineUserCount = yield Promise.all(
        ...
        res.render("groups/list", {
            ...
            nextStart: 15,
            title: "[[pages:groups]]",
            breadcrumbs: helpers_1.default.buildBreadcrumbs([
                { text: "[[pages:groups]]" },
            ]),
        });
    });
...
const details = function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const groupName = yield groups_1.default.getGroupNameByGroupSlug(
            req.params.slug,
        );
        if (!groupName) {
            return next();
        ...
        // eslint-disable-next-line @typescript-eslint/no-unsafe-call
        groupData.onlineUserCount = yield user_1.default.getGroupOnlineCount(
            groupData.name,
        );
...
const members = function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const users = yield user_1.default.getUsersFromSet(
        ...
        const breadcrumbs = helpers_1.default.buildBreadcrumbs([
            { text: "[[pages:groups]]", url: "/groups" },
            {
                text: validator_1.default.escape(String(groupName)),
