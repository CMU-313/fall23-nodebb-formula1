...
module.exports = function (User) {
    User.updateLastOnlineTime = function (uid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userData = yield db.getObjectFields(`user:${uid}`, [
                "status",
                "lastonline",
            ]);
            const now = Date.now();
    ...
    User.updateOnlineUsers = function (uid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield plugins.hooks.fire("action:user.online", {
                uid: uid,
                timestamp: now,
            });
        });
     ...
     */
    User.getGroupOnlineCount = function (groupName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // eslint-disable-next-line @typescript-eslint/no-unsafe-call
            const groupMemberMask = yield groups.isMembers(
                onlineUids,
                groupName,
            );
