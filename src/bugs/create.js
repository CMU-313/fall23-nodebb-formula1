...
module.exports = function (Bugs) {
    Bugs.create = function (data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bid = yield database_1.default.incrObjectField(
                "global",
                "nextBid",
            );
            /* eslint-enable max-len */
            // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
            yield plugins_1.default.hooks.fire("filter:bug.create", {
                bug: data,
                data: data,
            });
            /* eslint-disable max-len */
            ...
            yield plugins_1.default.hooks.fire("action:bug.save", {
                bug: lodash_1.default.clone(data),
                data: data,
            });
            return data.bid;
        });
    ...
    Bugs.post = function (data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bugData = data;
            bugData.bid = bid;
            yield plugins_1.default.hooks.fire("action:bug.post", {
                bug: bugData,
                data: data,
            });
            return {
