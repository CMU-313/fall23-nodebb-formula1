...
interface GroupsInterface {
    ...
    getGroupField: (groupName: string, field: string) => Promise<GroupDataField | null>;
    getGroupFields: (groupName: string, fields: string[]) => Promise<GroupDataObject | null>;
    getGroupData: (groupName: string) => Promise<GroupDataObject | null>;
    setGroupField: (groupName: string, field: string, value: GroupDataField) => Promise<void>;
...
export = function (Groups: GroupsInterface) {
    Groups.getGroupsFields = async function (groupNames: string[], fields: string[]): Promise<GroupDataObject[]> {
