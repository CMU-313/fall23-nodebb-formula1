...
module.exports = function (Groups) {
    function truncateMemberPosts(groupName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pids = yield database_1.default.getSortedSetRevRange(
            ...
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-call
            const score = yield database_1.default.sortedSetScore(
                `group:${groupName}:member:pids`,
                lastPid,
            );
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-call
            yield database_1.default.sortedSetsRemoveRangeByScore(
                [`group:${groupName}:member:pids`],
                "-inf",
                score,
            );
    ...
    Groups.onNewPostMade = function (postData) {
        return __awaiter(this, void 0, void 0, function* () {
            const allgroupNames = yield Groups.getUserGroupMembership(
            ...
            const groupData = yield _1.default.getGroupsFields(groupNames, [
                "memberPostCids",
            ]);
    ...
    Groups.getLatestMemberPosts = function (groupName, uid) {
        return __awaiter(this, void 0, void 0, function* () {
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-call
            let pids = yield database_1.default.getSortedSetRevRange(
                "posts:pid",
                0,
                -1,
            ); // Fetch all post ids
            pids = yield privileges_1.default.posts.filter(
                "topics:read",
                pids,
                uid,
            ); // fiter for privilege and access
            const allposts = // Get all post summaries from pids
                // eslint-disable-next-line @typescript-eslint/no-unsafe-call
                yield posts_1.default.getPostSummaryByPids(pids, uid, {
                    stripTags: false,
                });
                ...
                mainPosts.map(
                    ...
                    (post) =>
                        __awaiter(this, void 0, void 0, function* () {
                            return yield topics_1.default.getTopicDataByPid(
                                post.pid,
                            );
                        }),
                ),
            ...
            const postsInGroup = mainPosts.filter(
                (_, idx) => assignedGroupNames.at(idx).group === groupName,
            );
            return postsInGroup;
        });
    };
